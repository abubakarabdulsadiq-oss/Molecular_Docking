...
- Medicinal chemists
- Computational drug discovery practitioners

No prior experience with Schrödinger Maestro is assumed.

## Scope
The guide covers:
- End-to-end structure-based drug discovery workflows
- Best practices used in academia and industry
- Reproducible computational protocols
- Common beginner pitfalls and how to avoid them

## Citation
If you use or adapt this guide, please cite it as described in `CITATION.cff`.

## License
This work is released under the MIT License unless otherwise stated.
